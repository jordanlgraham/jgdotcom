 ...
 *
 */
$drupal_hash_salt = 'Y_99yL8p2@59cH$kfwFP4QzuNJYK+rjG^jS8q7eX7BB';
 ...
 * for you.
 */
 # Solution to redirect loop problem when a $base_url is set
 # from https://www.drupal.org/node/1693532
 # $base_protocol = empty($_SERVER['HTTPS']) || strtolower($_SERVER['HTTPS']) != 'on' ? 'http' : 'https';
 # $base_url = $base_protocol . '://projectcure.org';
